        ...
        {loading ? (
          ...
          isResetMode ? (
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mx-auto mt-10 max-w-md rounded-2xl border border-border p-8">
              ...
              <button onClick={handleGoogleAuth} disabled={signingIn} className="btn-lux mt-4 w-full border border-border bg-white text-foreground hover:bg-accent disabled:opacity-70">
              ...
              <div className="my-4 flex items-center gap-3 text-xs text-muted-foreground"><span className="h-px flex-1 bg-border" /><span>or continue with email</span><span className="h-px flex-1 bg-border" /></div>
